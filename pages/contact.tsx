...
const Result = () => {
    return (
        <h3 className="text-sky-500">Votre message est envoyée avec succés</h3>
    )
}
...
export default function Contact(props){
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_2bz8v7e', 'template_vypjqal', e.target, 'WhknivagNWvopErBR')
            .then((result) => {
        ...
        <div className="container mx-auto">
            <div className="max-w-xl p-1 mx-auto my-10 rounded-md shadow-sm">
                <div className="text-center">
                    <h3 className="my-4 text-3xl font-medium tracking-wider text-blue-600">Contactez-moi</h3>
